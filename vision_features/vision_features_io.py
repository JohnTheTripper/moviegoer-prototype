...
def thirds_points(frame):
    ...
    thirds_point_a = (one_third_width, one_third_height)
    thirds_point_b = (two_thirds_width, one_third_height)
    thirds_point_c = (one_third_width, two_thirds_height)
    thirds_point_d = (two_thirds_width, two_thirds_height)
...
# faces
def face_locations(film, frame_number):
    frame_folder = os.path.join('../frame_per_second', film)
    img_path = frame_folder + '/' + film + '_frame' + str(frame_number) + '.jpg'
